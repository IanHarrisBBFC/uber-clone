    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-gray-50">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          <h2 className="text-2xl font-bold text-[#111111] mb-2 text-center">Welcome to CabnFly</h2>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-[#111111] text-white py-4 px-6 rounded-xl font-semibold text-lg hover:bg-[#222222] transition duration-300 shadow-lg hover:shadow-xl"
          >
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-6 pt-6 border-t border-gray-200">
            <span className="text-xs px-3 py-1 bg-[#111111]/10 text-[#111111] rounded-full font-medium">Heathrow</span>
            <span className="text-xs px-3 py-1 bg-[#111111]/10 text-[#111111] rounded-full font-medium">Manchester</span>
            <span className="text-xs px-3 py-1 bg-[#111111]/10 text-[#111111] rounded-full font-medium">Birmingham</span>
            <span className="text-xs px-3 py-1 bg-[#111111]/10 text-[#111111] rounded-full font-medium">Gatwick</span>
          </div>
        </div>
      </div>
    </div>
